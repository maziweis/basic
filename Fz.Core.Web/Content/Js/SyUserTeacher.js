...
function formSuccess(result) {
    if (result.success) {
        $('#myModal').modal('hide');
        window.location = '/SyUserTeacher/Index';
    }
    else {
